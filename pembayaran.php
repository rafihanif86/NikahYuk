<?php 
    ...
    $cari;
    $queryVendor="SELECT * FROM pembayaran;"; //query vendor

    if(isset($_GET["search"])){
        $cari=$_GET["text_search"];
        $queryVendor="SELECT * FROM pembayaran WHERE `Uang_Muka` LIKE '%$cari%' OR `Id_Pemesanan` LIKE '%$cari%' OR `Status` LIKE '%$cari%';";
    }
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $row1["Uang_Muka"]; ?></td>
                                            <td><?php echo $row1["Id_Pemesanan"]; ?></td>
