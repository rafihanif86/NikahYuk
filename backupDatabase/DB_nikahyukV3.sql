...
CREATE TABLE `admin` (
  ...
  `Telp_Admin` varchar(12) DEFAULT NULL,
  `Id_login` int(11) NOT NULL,
  `Image_admin` varchar(10) DEFAULT NULL,
...
insert  into `admin`(`Id_Admin`,`Nama_Admin`,`Telp_Admin`,`Id_login`,`Image_admin`,`Email_admin`) values (1,'Rafi','081394893398',1,NULL,'rafizmujahid86@gmail.com'),(2,'mila','082233203907',3,NULL,'mila@gmail.com'),(3,'ivfa','085755827424',4,NULL,'ivfa@gmail.com'),(4,'bagus','081220875422',5,NULL,'bagus@gmail.com');
...
CREATE TABLE `customer` (
  ...
  `Image_cutomer` varchar(100) DEFAULT NULL,
  `id_login_custom` int(11) NOT NULL,
  PRIMARY KEY (`Id_Customer`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

/*Data for the table `customer` */

insert  into `customer`(`Id_Customer`,`Nama_Customer`,`Alamat_Customer`,`Telp_Customer`,`Email_customer`,`Image_cutomer`,`id_login_custom`) values (1,'silva','Jl.Semanggi Barat 15D Jatimulyo, Lowokwaru','085230431450','silva@gmail.com',NULL,18),(2,'ardian','Jl.Joyo Agung 33B Merjosari, Lowokwaru','081257547232','ardian@gmail.com',NULL,19);
...
CREATE TABLE `login` (
  ...
  PRIMARY KEY (`Id_login`,`Email_login`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=latin1;

/*Data for the table `login` */

insert  into `login`(`Id_login`,`Username`,`Password`,`Status`,`Email_login`) values (1,'rafi','rafi','admin','rafizmujahid86@gmail.com'),(2,'vendor1','vendor1','vendor','vendor@gmail.com'),(3,'mila','mila','admin','mila@gmain.com'),(4,'ivfa','ivfa','admin','ivfa@gmail.com'),(5,'bagus','bagus','admin','bagus@gmail.com'),(6,'prices2','princes','vendor','princessweddingorganizer@gmail.com'),(7,'mystory','mystory','vendor','mystoryorganizer@gmail.com'),(8,'gracia','gracia','vendor','graciaeventorganizer@gmail.com'),(9,'vip','vip','vendor','vipeventorganizer@gmail.com'),(10,'eleano','eleano','vendor','eleanooreweddingorginizer@gmail.com'),(11,'wisma','wisma','vendor','wismariasdanwo@gmail.com'),(12,'global','global','vendor','global99wedding@gmail.com'),(16,'kiki','kiki','customer','kiki@gmail.com'),(18,'silva','silva','customer','silva@gmail.com'),(19,'ardian','ardian','customer','ardian@gmail.com'),(29,'awewe','awewe','vendor','awewe@gmail.com'),(31,'iffarpro','iffarpro','vendor','iffarpro@gmail.com'),(32,'iffarpro','iffarpro','vendor','iffarpro@gmail.com'),(33,'mila','mila070513','vendor','faulia98@gmail.com');
...
insert  into `slider_vendor`(`id_slider`,`ft_background`,`ft_depan`,`ft_kanan`,`ft_kiri`,`status`,`id_vendor`,`Rating`,`Harga_termurah`,`keterangan`,`Ft_sampul_vendor`) values (1,'bali-vip-wedding-organizer-provide.jpg','aeug8kj876x7122120151402.jpg','pelaminan-pekanbaru.jpg','Resepsi1.jpg',1,3,4,5000000,'WO terbaik di Kota Malang',NULL),(2,'2-panggih-7-dulangan-trevo-pictures-Sk35kGi2f.jpg','2-panggih-1-balangan-gantal-le-motion-S1MnpZihM.jpg','2-ppf-kembar-mayang-SyD33Wj2z.jpg','5-adol-dawet-terralogical2-BJ0WT-o3z.png',1,2,4,7000000,'Pernikahan Adat Jawa ',NULL),(3,'anttijitters-SyGsFw22f.jpg','5-adol-dawet-terralogical2-BJ0WT-o3z.png','2-ppf-kembar-mayang-SyD33Wj2z.jpg','2-panggih-8-ngabekten-ppf-photography-and-videography-HJIsyGo2G.jpg',1,1,3,6000000,'Pernikahan Elegan',NULL);
...
CREATE TABLE `vendor` (
  ...
  `Telp_Vendor` varchar(12) DEFAULT NULL,
  `Id_Admin` int(11) NOT NULL,
  `Email_vendor` varchar(100) NOT NULL,
  `Image_vendor` varchar(100) DEFAULT NULL,
...
insert  into `vendor`(`Id_Vendor`,`Id_Login`,`Nama_Vendor`,`Alamat_Vendor`,`Telp_Vendor`,`Id_Admin`,`Email_vendor`,`Image_vendor`,`Instagram`) values (1,6,'Bagus Wedding Organizer','Jl.Kelengkeng 5 Bareng, Klojen ','0341 565367',1,'princessweddingorganizer@gmail.com','',''),(2,7,'My Story Event Organizer','Jl.Borobudur 3G Mojolangu, Lowokwaru','08121745428',1,'mystoryeventorganizer@gmail.com',NULL,NULL),(3,8,'Gracia Event Organizer','Jl.Kesumba Dalam 11A Jatimulyo, Lowokwaru','0341 498466',1,'graciaeventorganizer@gmail.com',NULL,NULL),(4,9,'VIP Event Organizer','Jl.Seram 06 Kasin, Klojen','0341 362844',1,'vipeventorganizer@gmail.com',NULL,NULL),(5,10,'Eleanoore Wedding Organizer','Griya Santa L-3 07 Mojolangu, Lowokwaru','081357010132',1,'eleanooreweddingorganizer@gmail.com',NULL,NULL),(6,11,'Wisma Rias & WO','Jl.Sulfat Agung V 6 Purwantoro, Blimbing','08123315551',1,'wismariasdanwo@gmail.com',NULL,NULL),(7,12,'Global 99 Wedding','Jl.Tumenggung Ssuryo 11 Kota Malang','341',1,'globalwedding@gmail.com',NULL,NULL),(8,29,'awewe','jl. Surabaya no.45 Malang','081434539228',1,'awewe@gmail.com',NULL,'@awewe'),(9,31,'iffarpro','jl, ahmad yani no.10 Malang','085839402339',1,'iffarpro@gmail.com','','@iffarpro'),(10,33,'mila','jalan semanggi barat 15D malang','082233203907',1,'faulia98@gmail.com','','@milafaulia');
