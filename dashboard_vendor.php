<?php 
    ...
    if(isset($_GET["search"])){
        ...
        $queryVendor="SELECT * FROM produk WHERE `Nama_Vendor` LIKE '%$cari%' OR `Alamat_Vendor` LIKE '%$cari%' OR `Telp_Vendor` LIKE '%$cari%' OR `Email_vendor` LIKE '%$cari%' OR `Instagram` LIKE '%$cari%';";
    }
...
<head>
    ...
    <title>Dashboard Vendor Nikah Yuk</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="vendor_produk.php"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="form-produk.php">Tambah Akun Produk</a></li>
                        </ul>
                    </li>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> <p align="center"> 
                                                <a  href="form-produk.php?edit=true&Id_Produk=<?php echo $row1["Id_Produk"];?>" class="btn btn-success btn-sm"> <i class='fa fa-pencil fa-2x'> </i> </a> 
                                                <a  href="produk_hapus.php?delete=true&Id_Produk=<?php echo $row1["Id_Produk"];?>" class="btn btn-danger btn-sm"> <i class='fa fa-trash-o fa-2x'> </i> </a>
                                            </p>
                                            </td>
                                        </tr>
                                    <?php
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> 1 </td>
                                                    <td>  <span class="name">Silva Aisya</span> </td>
                                                    <td> <span class="product">Sasana Krida UM</span> </td>
                                                    <td><span class="Date">25-03-2019</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 2 </td>
                                                    <td>  <span class="name">Ardian Aulia</span> </td>
                                                    <td> <span class="product">Swiss Belin Bronze Package</span> </td>
                                                    <td><span class="Date">03-05-2019</span></td>
                                                    <td>
                                                        <span class="badge badge-complete">Process</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <div class="tdl-holder">
                                            <div class="tdl-content">
                                                <ul>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox"><i class="check-box"></i><span>Bertemu Customer Ardian tanggal 01-05-2019</span>
                                                    ...
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" checked><i class="check-box"></i><span>Menyewa gedung customer Silva Aisya Sasana Krida UM</span>
                                                            <a href='#' class="fa fa-times"></a>
                                                            <a href='#' class="fa fa-pencil"></a>
                                                            <a href='#' class="fa fa-check"></a>
                                                        </label>
                                                ...
                                                <div class="msg-received msg-container">
                                                    ...
                                                    <div class="msg-box">
                                                        <div class="inner-box">
                                                            ...
                                                            <div class="meg">
                                                                Kapan kita bisa bertemu untuk membicarakan pesanan saya?
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- /.msg-received -->
                                                ...
                                                <div class="msg-sent msg-container">
                                                    ...
                                                    <div class="msg-box">
                                                        <div class="inner-box">
                                                            ...
                                                            <div class="meg">
                                                                Baik, mohon ditunggu sebentar. kami sedang mencari jadwal untuk bertemu dengan anda.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- /.msg-sent -->
