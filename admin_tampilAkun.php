<?php 
    ...
    $cari;
    $queryVendor="SELECT * FROM admin;"; //query vendor

    if(isset($_GET["search"])){
        $cari=$_GET["text_search"];
        $queryVendor="SELECT * FROM admin WHERE `Nama_Admin` LIKE '%$cari%' OR `Telp_Admin` LIKE '%$cari%' OR `Email_admin` LIKE '%$cari%';";
    }
...
?>
<form action="admin_form.php?Id_Admin=<?php echo $_GET['Id_Admin'] ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src='images/<?php echo $row1["Image_admin"]; ?>' alt=""></a>
                                                </div>
                                            </td>
                                            <td><?php echo $row1["Nama_Admin"]; ?></td>
                                            <td><?php echo $row1["Telp_Admin"]; ?></td>
                                            <td><?php echo $row1["Email_admin"]; ?></td>
                                            <td> <p align="center"> 
                                                <a  href="admin_form.php?edit=true&Id_Admin=<?php echo $row1["Id_Admin"];?>" class="btn btn-success btn-sm"> <i class='fa fa-pencil fa-2x'> </i> </a> 
												|
                                                <a  href="admin_delete.php?Id_Admin=<?php echo $row1["Id_Admin"];?>" class="btn btn-danger btn-sm"> <i class='fa fa-trash-o fa-2x'> </i> </a>
											</p>
											</td>
                                        </tr>
                                    <?php
