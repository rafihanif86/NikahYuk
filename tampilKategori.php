<?php 
    ...
    $cari;
    $queryVendor="SELECT * FROM kategori;"; //query vendor

    if(isset($_GET['Id_category'])){
        $id_Cat = $_GET['Id_category'];
        $queryVendor="SELECT * FROM kategori where Id_category = $id_Cat;";
    }

    if(isset($_GET["search"])){
        $cari=$_GET["text_search"];
        $queryVendor="SELECT * FROM kategori WHERE `Category_Name` LIKE '%$cari%' ;";
    }
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> <p align="center"> 
                                                <a  href="tampilKategori_form.php?edit=true&Id_category=<?php echo $row1["Id_category"];?>" class="btn btn-success btn-sm"> <i class='fa fa-pencil fa-2x'> </i> </a> 
												|
                                                <a  href="deleteKategori.php?Id_category=<?php echo $row1["Id_category"];?>" class="btn btn-danger btn-sm"> <i class='fa fa-trash-o fa-2x'> </i> </a>
											</p>
											</td>
                                        </tr>
                                    <?php
