<?php 
    ...
    $cari;
    $queryVendor="SELECT * FROM vendor;"; //query vendor

    if(isset($_GET["search"])){
        $cari=$_GET["text_search"];
        $queryVendor="SELECT * FROM vendor WHERE `Nama_Vendor` LIKE '%$cari%' OR `Alamat_Vendor` LIKE '%$cari%' OR `Telp_Vendor` LIKE '%$cari%' OR `Email_vendor` LIKE '%$cari%' OR `Instagram` LIKE '%$cari%';";
    }
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="customer_tampilAkun.html">Tabel Akun Customer</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="images/<?php echo $row1["Image_vendor"]; ?>" alt=""></a>
                                                </div>
                                            </td>
                                            <td><?php echo $row1["Nama_Vendor"]; ?></td>
                                            <td><?php echo $row1["Alamat_Vendor"]; ?></td>
                                            <td><?php echo $row1["Telp_Vendor"]; ?></td>
                                            <td><?php echo $row1["Email_vendor"]; ?></td>
                                            <td><?php echo $row1["Instagram"]; ?></td>
                                            <td> 
                                                <a  href="vendor_form.php?edit=true&id_vendor=<?php echo $row1["Id_Vendor"];?>"> <i class='fa fa-pencil fa-2x'> </i> </a> 
                                                <a  href="vendor_delete.php?id_vendor=<?php echo $row1["Id_Vendor"];?>"> <i class='fa fa-trash-o fa-2x'> </i> </a>
                                            </td>
                                        </tr>
                                    <?php
                                        }
